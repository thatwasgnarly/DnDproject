...
public class Trait {
    ...
    public static Trait getTraitByChoice(int choice) {
        switch (choice) {
            case 1:
                return new Trait("Warrior", "Gain bonus HP", "hp");
            case 2:
                return new Trait("Wizard", "Bonus to Intelligence", "intelligence");
            case 3:
                return new Trait("Rogue", "Bonus to Dexterity", "dexterity");
            default:
